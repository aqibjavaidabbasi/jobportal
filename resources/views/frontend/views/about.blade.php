...
@section('content')
        ...
        <div class="apply-process-area apply-bg pt-150 pb-150" data-background="{{asset('fontend-assets/img/gallery/how-applybg.png')}}" style="background-image: url({{asset('fontend-assets/img/gallery/how-applybg.png')}};">
            <div class="container">
                <!-- Section Tittle -->
                <div class="row">
                    <div class="col-lg-12">
