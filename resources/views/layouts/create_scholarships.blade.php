...
<div class="card">
  <div class="card-header">Add Scholarships.</div>
  <div class="card-body">
  ...
  <form action="{{ url('Insert_data') }}" method="post">
    ...
    <div class="col-4 col-md-4">
        ...
        <input type="text" name="NOS" id="NOS" class="form-control" require>
        @error('NOS')
        <span class="text-danger" role="alert">
        <strong>{{ $message }}</strong>
        </span>
        ...
        <input type="text" name="tg" id="tg" class="form-control" require>
        @error('tg')
        <span class="text-danger" role="alert">
        <strong>{{ $message }}</strong>
        </span>
        ...
        <textarea name="inclusions" id="inclusions" class="form-control" ></textarea>
        @error('inclusions')
        <span class="text-danger" role="alert">
        <strong>{{ $message }}</strong>
        </span>
    ...
    <label> Application instructions </label></br>
        ...
        <input type="text" name="deadline" id="deadline" class="form-control" require>
        @error('deadline')
        <span class="text-danger" role="alert">
        <strong>{{ $message }}</strong>
        </span>
        ...
        <input type="text" name="joining_date" id="joining_date" class="form-control" require>
        @error('joining_date')
        <span class="text-danger" role="alert">
        <strong>{{ $message }}</strong>
        </span>
