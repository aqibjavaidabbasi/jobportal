  ...
  <form action="{{ url('job') }}" method="post">
     ...
     <div class="row">
       <div class="col-4 col-md-4">
        ...
        <textarea name="jobd" id="jobd" class="form-control" ></textarea>
        @error('jobd')
        <span class="text-danger" role="alert">
        <strong>{{ $message }}</strong>
        </span>
        ...
        <textarea name="qf" id="qf" class="form-control" ></textarea>
        @error('qf')
        <span class="text-danger" role="alert">
        <strong>{{ $message }}</strong>
        </span>
        ...
        <select class="form-select" name="jobt" aria-label="Default select example">
        ...
        <input type="text" name="joind" id="joind" class="form-control" >
        @error('joind')
        <span class="text-danger" role="alert">
        <strong>{{ $message }}</strong>
        </span>
