    ...
    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true" data-img="theme-assets/images/backgrounds/02.jpg">
      ...
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class=" active "><a href="/scholarships"><i class="ft-pie-chart"></i><span class="menu-title" data-i18n=""> Scholarships </span></a>
          </li>
            ...
            <div class="breadcrumbs-top float-md-right">
              <div class="breadcrumb-wrapper mr-1">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Scholarship Page
                  </li>
                </ol>
              </div>
            </div>
...
@endif 
                        ...
                        <a href="{{ url('/Add_scholarships') }}" class="btn btn-primary btn-sm" title="Add New Record" style="margin-left: 55.4rem;" >
                            ...
                            <table class="table" id="myTable">
                                <thead class="table-light" >
                                    <tr>
                                        ...
                                        <th scope="col" onclick="sortTable(3)" >Institution</th>
                                        <th scope="col" onclick="sortTable(4)" >Fields of study</th>
                                        <th>Action</th>
                                        <!-- <th>Password</th> -->
                                    </tr>
                                </thead>
...
<div class="modal fade" id="bulk" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="{{ url('/delete-selected-data') }}" method="POST">
      {{ method_field('DELETE') }}
      {{ csrf_field() }}
        @csrf
...
<div class="modal fade" id="deletemodal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <form action="{{ url('update-data') }}" method="post"  id="editdata" >
        {!! csrf_field() !!}
        @method("PATCH")
    ...
    <div class="col-4 col-md-4">
        ...
        <label> Host Institution(s) </label></br>
        ...
        <label> Fields of study </label></br>
        <input type="text" name="field" id="field1" class="form-control" >
        @error('field')
        <span class="text-danger" role="alert">
        <strong>{{ $message }}</strong>
        </span>
    ...
    <div class="col-4 col-md-4">
        ...
        <label>Number of Awards</label></br>
        <input type="text" name="NOS" id="NOS1" class="form-control" require>
        @error('NOS')
        <span class="text-danger" role="alert">
        <strong>{{ $message }}</strong>
        </span>
        ...
        <input type="text" name="tg" id="tg1" class="form-control" require>
        @error('tg')
        <span class="text-danger" role="alert">
        <strong>{{ $message }}</strong>
        </span>
        ...
        <label> Inclusions/duration </label></br>
        <textarea name="inclusions" id="inclusions1" class="form-control" ></textarea>
        @error('inclusions')
        <span class="text-danger" role="alert">
        <strong>{{ $message }}</strong>
        </span>
        ...
        <textarea name="eligibility" id="eligibility1" class="form-control" ></textarea>
        @error('eligibility')
        <span class="text-danger" role="alert">
        <strong>{{ $message }}</strong>
        </span>
    ...
    <label> Application instructions </label></br>
        <textarea name="instructions" id="instructions1" class="form-control" ></textarea>
        @error('instructions')
        <span class="text-danger" role="alert">
        <strong>{{ $message }}</strong>
        </span>
        ...
        <input type="text" name="deadline" id="deadline1" class="form-control" require>
        @error('deadline')
        <span class="text-danger" role="alert">
        <strong>{{ $message }}</strong>
        </span>
        ...
        <input type="text" name="joining_date" id="joining_date1" class="form-control" require>
        @error('joining_date')
        <span class="text-danger" role="alert">
        <strong>{{ $message }}</strong>
        </span>
...
<div class="modal fade" id="viewmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="card-body">
      ...
      <ol class="list-group list-group-numbered">
        ...
        <li class="list-group-item" id="vietitle" > Name: </li>
        <li class="list-group-item" id="viewname" > Email :  </li>
        <li class="list-group-item" id="viewfield" > Phone :  </li>
        <li class="list-group-item" id="viewdescription" > Type :  </li>
        <li class="list-group-item" id="viewNOS" > Address :  </li>
        
        <li class="list-group-item" id="viewtg" > Name: </li>
        <li class="list-group-item" id="viewinclusions" > Email :  </li>
        <li class="list-group-item" id="vieweligibility" > Phone :  </li>
        <li class="list-group-item" id="viewinstructions" > Type :  </li>
        <li class="list-group-item" id="viewdeadline" > Address :  </li>
        
        <li class="list-group-item" id="viewjoining_date" > Name: </li>
        <li class="list-group-item" id="viewaddress" > Email :  </li>
  ...
  $(document).ready(function()
    {
      ...
      $(document).on('click', '.view', function()
      {
        ...
        $.ajax({
          type : "GET",
          url : "/view_data/"+userid,
          success : function(response){
             console.log(response);
             console.log(response.scholarships.name);
            // $('#userid').val(userid);
        
             document.getElementById("vietitle").innerHTML = response.scholarships.title;
             document.getElementById("viewname").innerHTML = response.scholarships.name;
             document.getElementById("viewfield").innerHTML = response.scholarships.field;
             document.getElementById("viewdescription").innerHTML = response.scholarships.description;
             document.getElementById("viewNOS").innerHTML = response.scholarships.NOS;
             document.getElementById("viewtg").innerHTML = response.scholarships.tg;
             document.getElementById("viewinclusions").innerHTML = response.scholarships.inclusions;
             document.getElementById("vieweligibility").innerHTML = response.scholarships.eligibility;
             document.getElementById("viewinstructions").innerHTML = response.scholarships.instructions;
             document.getElementById("viewdeadline").innerHTML = response.scholarships.deadline;
             document.getElementById("viewjoining_date").innerHTML = response.scholarships.joining_date;
             document.getElementById("viewaddress").innerHTML = response.scholarships.address;
      ...
      $(document).on('click', '.edit', function()
      {
        ...
        $.ajax({
          ...
          success : function(response){
            ...
            $('#userid').val(userid);
            $('#title1').val(response.scholarships.title);
            $('#name1').val(response.scholarships.name);
            $('#field1').val(response.scholarships.field);
            $('#description1').val(response.scholarships.description);
            $('#NOS1').val(response.scholarships.NOS);
            $('#tg1').val(response.scholarships.tg);
            $('#NOS1').val(response.scholarships.NOS);
            $('#tg1').val(response.scholarships.tg);
            $('#inclusions1').val(response.scholarships.inclusions);
            $('#eligibility1').val(response.scholarships.eligibility);
            $('#instructions1').val(response.scholarships.instructions);
            $('#deadline1').val(response.scholarships.deadline);

            $('#joining_date1').val(response.scholarships.joining_date);
            $('#address1').val(response.scholarships.address);
