    ...
    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true" data-img="theme-assets/images/backgrounds/02.jpg">
      ...
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          <li class=" active"><a href="/home"><i class="ft-home"></i><span class="menu-title" data-i18n="">Dashboard</span></a>
          </li>
...
@endif 
                        ...
                        <a href="{{ url('/user/create') }}" class="btn btn-primary btn-sm" title="Add New Record" style="margin-left: 55.4rem;" >
                            ...
                            <table class="table" id="myTable">
                                <thead class="table-light" >
                                    <tr>
                                        ...
                                        <th scope="col" onclick="sortTable(4)" >Role</th>
                                        <th> Action </th>
                                        <!-- <th>Password</th> -->
                                    </tr>
                                </thead>
...
<div class="modal fade" id="bulk" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="{{ url('/delete-selected-user') }}" method="POST">
      {{ method_field('DELETE') }}
      {{ csrf_field() }}
        @csrf
...
<div class="modal fade" id="deletemodal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="card-header"><h5>Edit User Data </h5></div>
  <div class="card-body">
      
  <form action="{{ url('update-user') }}" method="post"  id="editdata" >
        {!! csrf_field() !!}
        @method("PATCH")
        ...
        <select class="form-select" name="is_admin" id="is_admin" aria-label="Default select example" require>
...
<div class="modal fade" id="viewmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="card-body">
      ...
      <ol class="list-group list-group-numbered">
        ...
        <li class="list-group-item" id="viewpass" > Password :  </li>
        <li class="list-group-item" id="view-admin" > Role :  </li>
  ...
  $(document).ready(function()
    {
      ...
      $(document).on('click', '.view', function()
      {
        ...
        $.ajax({
          ...
          success : function(response){
            ...
            // $('#userid').val(userid);
             document.getElementById("viewname").innerHTML = response.users.name;
             document.getElementById("viewemail").innerHTML = response.users.email;
             document.getElementById("viewpass").innerHTML = response.users.password;
             document.getElementById("view-admin").innerHTML = response.users.is_admin;
      ...
      $(document).on('click', '.edit', function()
      {
        ...
        $.ajax({
          ...
          success : function(response){
             //console.log(response);
             console.log(response.users.userid);
             console.log(response.users.name);
            ...
            $('#is_admin').val(response.users.is_admin);
